...
# Одна страница = 50 лотов = ОДИН запрос к CSFloat.
#
...
# шесть раз.
#
# Во-вторых, и это важнее: страницы 2-4 не могут содержать ничего нужного.
# Скан ходит с sort_by="highest_discount", то есть CSFloat уже отсортировал
# лоты по скидке к цене Steam по убыванию. Страница 1 — это и есть 50 самых
# недооценённых лотов рынка; всё, что дальше, по определению хуже. Порог
# отбора отсекает снизу, так что если 50 лучших лотов порог не прошли, то
